...
public class SharedPrefManager {
    ...
    private static final String KEY_USER_ADR = "adr";
    private static final String KEY_USER_prix = "prix";
    ...
    public boolean userLogin(int id, String nom, String email, String type,String tel, String adr , Integer prix){
        ...
        editor.putString(KEY_USER_ADR,adr);
        editor.putInt(KEY_USER_prix,prix);
        editor.apply();
    ...
    public String getUserAdresse(){
        SharedPreferences sharedPreferences = mCtx.getSharedPreferences(SHARED_PREF_NAME, Context.MODE_PRIVATE);
        return sharedPreferences.getString(KEY_USER_ADR, null);
    }
    public String getUserTel(){
        SharedPreferences sharedPreferences = mCtx.getSharedPreferences(SHARED_PREF_NAME, Context.MODE_PRIVATE);
        return sharedPreferences.getString(KEY_USER_TEL, null);
    }
    public Integer getUserPrix(){
        SharedPreferences sharedPreferences = mCtx.getSharedPreferences(SHARED_PREF_NAME, Context.MODE_PRIVATE);
        return sharedPreferences.getInt(KEY_USER_prix, -1);
    }
}